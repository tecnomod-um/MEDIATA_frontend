...
function DataExporter({ data, filteredData }) {
    ...
    const exportData = () => {
        ...
        console.log(data.categoricalFeatures)
        const categoricalData = data.categoricalFeatures.map(feature => ({
            Name: feature.featureName,
            'Total Count': feature.count.toString(),
            Mode: feature.mode || 'N/A',
            'Mode Frequency': feature.modeFrequency ? feature.modeFrequency.toString() : 'N/A',
            'Mode %': feature.modeFrequencyPercentage ? feature.modeFrequencyPercentage.toFixed(2) + '%' : 'N/A',
            '2nd Mode': feature.secondMode || 'N/A',
            '2nd Mode Frequency': feature.secondModeFrequency ? feature.secondModeFrequency.toString() : 'N/A',
            '2nd Mode %': feature.secondModePercentage ? feature.secondModePercentage.toFixed(2) + '%' : 'N/A',
            'Missing Entries': feature.missingValuesCount.toString(),
