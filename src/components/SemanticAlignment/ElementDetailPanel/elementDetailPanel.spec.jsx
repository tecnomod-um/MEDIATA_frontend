...
vi.mock("@mui/icons-material/Delete", () => ({
  __esModule: true,
  default: () => <span data-testid="icon-del" />,
}));

vi.mock("@mui/icons-material/AddBox", () => ({
  __esModule: true,
...
vi.mock("../../Common/AutoCompleteInput/autoCompleteInput", () => ({
  __esModule: true,
...
vi.mock("../../Common/TooltipPopup/tooltipPopup", () => ({
  __esModule: true,
  default: ({ message }) => <span data-testid="tooltip">{message}</span>,
}));

const mockFetchClasses = vi.fn();
const mockFetchClassFields = vi.fn();
...
describe("<ElementDetailPanel />", () => {
  ...
  it("typing into a string field updates state & fetches suggestions", async () => {
    const setElementFormValues = vi.fn();
