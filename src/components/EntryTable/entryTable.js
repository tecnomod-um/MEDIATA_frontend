...
const Row = React.memo(
  ({ rowIndex, filteredLists, onRowClick, selectedEntry, type }) => {
    ...
    const rowClassName = `${EntryTableStyles.resTr} ${
      isRowSelected ? EntryTableStyles.selectedRow : ""
    }`;
        ...
        {Object.keys(filteredLists).map((key) => (
          <td
            ...
            className={`${EntryTableStyles.resTd} ${
              isRowSelected ? EntryTableStyles.selectedEntry : ""
            }`}
          >
          ...
          {columns.map(({ ref, text }, i) => (
            <th className={EntryTableStyles.resTh} ref={ref} key={text}>
              ...
              <div
                ...
                className={`${EntryTableStyles.resizeHandle} ${
                  activeIndex === i ? EntryTableStyles.active : "idle"
                }`}
              />
            </th>
          ))}
