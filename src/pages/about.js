            ...
            <div className={AboutStyles.container}>
                <section className={AboutStyles.section}>
                    ...
                    <ul className={AboutStyles.memberList}>
                        <li className={AboutStyles.memberItem}>
                            ...
                            <span className={AboutStyles.memberName}>Catalina Martinez Costa</span>
                        </li>
                        <li className={AboutStyles.memberItem}>
                ...
                <div className={AboutStyles.infoResourcesWrapper}>
                    <section className={AboutStyles.section}>
                        ...
                        <p className={AboutStyles.contactInfo}>Email: cmartinezcosta@um.es</p>
                    ...
                    <section className={AboutStyles.section}>
                        ...
                        <p className={AboutStyles.sectionText}>
                            For more information, user guides, or to contribute to the project, visit our <a href="https://github.com/orgs/tecnomod-um/TODO" className={AboutStyles.link}>GitHub page</a>.
                        </p>
                    </section>
                </div>
            </div>
