...
function Tutorial() {
  ...
  const discoveryControls = [
    ...
    },
    {
      title: "File selector",
      description:
        "When multiple files are loaded, lets you choose which files contribute to the current view. Files are grouped by Node. Enable all selected files when you want the tables, charts, and aggregate metrics to reflect the complete loaded set.",
      accent: "amber",
      icon: "folder",
    },
    {
      ...
      description:
        "Lets you show or hide individual features from the tables and charts. A search box is also available, together with a Show All / Hide All control for the currently displayed results. Use it to focus on a specific feature, hide noisy columns temporarily, and restore them when needed.",
      accent: "orange",
      icon: "toggle",
    },
    {
    ...
    },
    {
      ...
      description:
        "Generates and uploads element metadata files from the loaded datasets so that those metadata files can be selected later in the Integration tab.",
      accent: "emerald",
      icon: "upload",
    },
  ];
            ...
            <div className={TutorialStyles.textContainer}>
              ...
              <div className={TutorialStyles.introText}>
                ...
                <p>
                  ...
                  at the same time. To do this, drag the Nodes of interest next to each other and click
                  the <em>Join nodes</em> control that appears between them.
                </p>
                <PageImage
                  imageSrc={nodesGif}
                  maintainAspectRatio={true}
                ...
                <p>
                  A DCAT description is a structured metadata record that describes a dataset, including information
                  such as its title, description, publisher, available distributions, formats, access URLs, and related
                  documentation. These descriptions help users understand what datasets are available
                  within a Node before accessing or working with them.
                </p>
                <p>
          ...
          <div className={TutorialStyles.textContainer}>
            ...
            <div className={TutorialStyles.introText}>
              ...
              <p>
                ...
                will indicate that multiple files are selected in the top-right corner. This same selection pattern is
                used when loading several datasets in Discovery, several element files in Integration, or several source
                files in the processing modal.
              </p>
              <p>
        ...
        <div id="Data-cleaning" className={TutorialStyles.contentContainer}>
          <div className={TutorialStyles.textContainer}>
            ...
            <div className={TutorialStyles.introText}>
              ...
              <p>
                A common cleaning workflow is removing a clearly invalid row after detecting it in Discovery.
                For example, if a continuous feature contains an obvious outlier value such as <code>999</code>,
                select the source file in the File Explorer, choose <em> Remove rows with pattern</em>, set the
                affected column, and use a pattern such as <code>^999$</code> so only that row is removed. After
                applying the step, reopen the cleaned output in Discovery and confirm that the outlier is no longer
                present.
              </p>
              <p>
          ...
          <div className={TutorialStyles.textImageContainer}>
            <div className={TutorialStyles.textContainer}>
              ...
              <div className={TutorialStyles.introText}>
                ...
                <p>
                  When several datasets are open, the sidebar controls determine what is actually included in the
                  visible results. Use the file selector to enable the files that should contribute to the current
                  view, and use the feature toggles to show or hide specific columns. If a column or file appears to be
                  missing, first check that the corresponding file is enabled and that the feature has not been hidden
                  with the feature toggles.
                </p>
            ...
            <div className={TutorialStyles.textContainer}>
              ...
              <div className={TutorialStyles.introText}>
                <p>
                  ...
                  files, which will determine the set of features available to work with. In a local evaluation workflow,
                  these metadata files are usually the element files generated from Discovery using the
                  <em> Upload elements</em> control.
                </p>
                ...
                <p>
                  If you are evaluating multiple files, select all of their generated element files when the Integration
                  File Explorer opens. Use <code>Ctrl</code>-click, <code>Shift</code>-click, or a long press to select
                  more than one row. If the expected files are not available there, return to Discovery, open the source
                  datasets, and generate the element metadata first.
                </p>
                ...
                <p>
                  ...
                  and streamline the mapping process. A schema is optional, but when one is provided, suggested mappings
                  can use it as a target structure instead of only grouping source columns by similarity.
                </p>
          ...
          <div className={TutorialStyles.textImageContainer}>
            <div className={TutorialStyles.textContainer}>
              ...
              <div className={TutorialStyles.introText}>
                ...
                <p>
                  For categorical mappings, select the source columns first, define the normalized output labels, and then
                  assign each source category to the correct output value. For numeric score mappings, define the output
                  values or score bands and assign source ranges to each one. This is the same interaction used for simple
                  demographic fields, binary categories, and multi-level assessment or score variables.
                </p>
                <p>
                ...
                <p>
                  ...
                  of the default mappings). Suggested mappings should be reviewed before processing: check the produced column
                  names, the source columns grouped under each mapping, and the value assignments or numeric ranges inside them.
                </p>
            ...
            <div className={TutorialStyles.textContainer}>
              ...
              <div className={TutorialStyles.introText}>
                ...
                <p>
                  ...
                  applying all transformations defined by the mapping. Make sure each source dataset you want to transform is
                  selected in this modal; files left unselected will not be processed.
                </p>
                ...
                <p>
                  ...
                  further analysis. After returning to Discovery, inspect the parsed files as normal datasets: enable all relevant
                  files, show the features you need, and use the data-cleaning panel if a small format issue needs to be corrected.
                </p>
              </div>
            </div>
          </div>
