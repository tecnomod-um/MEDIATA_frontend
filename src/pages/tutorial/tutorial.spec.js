...
jest.mock('../../resources/images/tutorial/1_nodes.gif', () => 'nodes_gif');
jest.mock('../../resources/images/tutorial/2_navbar.gif', () => 'navbar_gif');
jest.mock('../../resources/images/tutorial/3_integration_usage.gif', () => 'integration_usage_gif');
jest.mock('../../resources/images/tutorial/4_change_files_modal.png', () => 'change_files_png');

jest.mock('../../components/Common/ScrollSidebar/scrollSidebar.js', () => (props) => {
...
jest.mock('../../components/Common/Slide/slide.js', () => (props) => {
...
jest.mock('../../components/Common/PageImage/pageImage.js', () => (props) => {
  const { alt = '' } = props || {};
